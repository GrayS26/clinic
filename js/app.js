(() => {
    ...
    function initSliders() {
        if (document.querySelector(".main-section__slider")) {
            const mainSlider = new swiper_core_Swiper(".main-section__slider", {
...
***************************************************************************** */
    ...
    if (beforeAfter) {
        ...
        isMobile.any() ? beforeAfterArrow.addEventListener("touchstart", beforeAfterInit) : beforeAfterArrow.addEventListener("mousedown", beforeAfterInit);
